...
where \(\beta \sim \mathcal{O}(10^{-5})\) hides the precise knowledge of backscattering. Apart from irrelevant coefficients of order \(1\), this shall also coincide with the expected rate of contraction of the area of the horizion, \(\frac{\delta\mathcal{A}}{\mathcal{A}}\).
...
\begin{figure}
	...
	% todo: metti penrose diagram come in figura 1 dell'articolo di Minguzzi
...
\subsection{Past reflectivity}
	...
	Past reflectivity is not a causality condition.
