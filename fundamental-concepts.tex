...
With similar arguments we have that \(J^+(A) \subseteq \bar{I}^+(A)\), and since clearly \(I^+(A) \cup A \subseteq J^+(A)\) it's clear that \(\bar{J}^+(A) = \bar{I}^+(A)\) and \(\partial J^+(A) = \partial I^+(A)\).
