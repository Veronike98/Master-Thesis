...
It's evident then that the Levi-Civita connection on \(M\) is \EAK{I don't understand the rest of this sentence. Perhaps: ``it is missing something in respect''} missing something in respect to the induced connection from \(\bar{M}\). This is precisely the object we have been looking for:
