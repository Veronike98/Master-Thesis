...
\begin{remark}
	...
	\draw[orange] (a) to [out = 15, in = -115] (e);
	\draw[dashed, orange] (e) to [out = 125, in = -20] (f);
	\draw[orange] (f) to [out = 15, in = -145] (g);
	\draw[thick, green] (h) -- (g);
	\foreach \i in {h,g} {\fill[green] (\i) circle(.8pt);}
