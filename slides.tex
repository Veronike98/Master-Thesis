...
{A generalization of the Black Hole Area theorem}
...
%	}
	...
	\begin{frame}
		...
		\begin{columns}
			...
			\vskip 15pt
			\begin{tikzpicture}
				\node[graduate, stripes=turquoise!80!black, minimum size = 2cm] (A) at (0,0){};
			\end{tikzpicture}
			\column{0.33\textwidth}
			\includegraphics[scale=0.5]{Immagini/confused-person.png}
			\column{0.33\textwidth}
			\centering
			\begin{tikzpicture}
				\node[graduate, mirrored, stripes=turquoise!80!black, minimum size = 2cm] (A) at (0,0){};
			\end{tikzpicture}
